...
안녕하세요. 16년차 소프트웨어 개발자입니다.<br/>
세상에 안되는 일은 없다는 신념으로 개발에 매진하는 중입니다.<br/>
코끼리를 냉장고에 넣으려면, 문여는 동료, 코끼리를 넣는 동료, 문 닫는 동료가 있으면 가능합니다.<br/>
제가 코끼리를 냉장고에 넣는 <font style="color:red;">신화를 창조하는 믿음직한 당신의 동료</font>가 되어드리겠습니다.
